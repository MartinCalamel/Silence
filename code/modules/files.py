...
def read(file_name:str, delimiter:str)->list:
    ...
    # read
    ## Fonction
    lit un fichier s'il exite et retourne son contenu sous la forme [lignes[delimiteur]]
    ## Input
    * file_name : str -> Nom du fichier + path si requis
...
def write(file_name:str, data:str)-> None:
    ...
    # write
    ## Fonction
    ecrit le contenue de data dans le fichier en EFFACANT le contenue du fichier
    ## Input
    * file_name : str -> Nom du fichier + path si requis
